  ...
  always @* begin
    ...
    case (M_state_q)
      BEGIN_state: begin
        ...
        M_button_a_d[0+2-:3] = M_random_num[0+2-:3] + M_random_num[5+1-:2];
        M_button_b_d[0+2-:3] = M_random_num[2+2-:3] + M_random_num[13+1-:2];
        M_button_c_d[0+2-:3] = M_random_num[7+2-:3] + M_random_num[4+1-:2];
        M_button_d_d[0+2-:3] = M_random_num[8+2-:3] + M_random_num[2+1-:2];
